...
- https://developers.popbill.com/reference/sms/python/common-api/point#GetRefundableBalance
"""
...
try:
    ...
    refundableBalance = messageService.getRefundableBalance(CorpNum, UserID)
