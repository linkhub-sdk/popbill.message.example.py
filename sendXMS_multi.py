...
try:
    ...
    Subject = "동보전송용 메시지 제목" # 메시지제목(동보전송용)
    Contents = "동보전송용 메시지 내용" # 메시지 내용(동보전송용)
    ...
    receiptNum = messageService.sendXMS_multi(testValue.testCorpNum,Sender,Subject,Contents,messages,reserveDT)
