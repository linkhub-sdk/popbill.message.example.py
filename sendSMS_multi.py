...
try:
    ...
    Contents = "동보전송용 메시지 내용" # 단문메시지 내용(동보전송용)
    reserveDT = "20150326200000" # 예약전송시간, 형태 yyyyMMddHHmmss 공백 기재시 즉시전송

    messages = [] # 개별수신정보 배열(최대 10000건)
    ...
    receiptNum = messageService.sendSMS_multi(testValue.testCorpNum,Sender,Contents,messages,reserveDT)
