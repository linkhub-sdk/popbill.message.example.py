...
- https://developers.popbill.com/reference/sms/python/common-api/point#GetSettleResult
"""
...
try:
    ...
    paymentHistory = messageService.getSettleResult(CorpNum, SettleCode, UserID)
