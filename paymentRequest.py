...
import testValue
from popbill import MessageService, PaymentForm, PopbillException
...
- https://developers.popbill.com/reference/sms/python/common-api/point#PaymentRequest
"""
...
try:
    ...
    paymentResponse = messageService.paymentRequest(CorpNum, paymentForm, UserID)
