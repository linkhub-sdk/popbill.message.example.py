...
- https://developers.popbill.com/reference/sms/python/common-api/point#GetPaymentHistory
"""
...
try:
    ...
    paymentHistoryResult = messageService.getPaymentHistory(CorpNum,SDate,EDate,Page,PerPage,UserID)
