...
- https://developers.popbill.com/reference/sms/python/common-api/point#GetRefundHistory
"""
...
try:
    ...
    refundHistoryResult = messageService.getRefundHistory(CorpNum, Page, PerPage, UserID)
